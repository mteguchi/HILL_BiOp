...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_JM_month_var_1999_jagsUI.png',
         dpi = 600)
...
if (plot.fig){
  ...
  mcmc_trace(zm$samples, c('theta', "sigma.pro1", "sigma.pro2", "sigma.obs"))
  mcmc_dens(zm$samples, c('theta', "sigma.pro1", "sigma.pro2", "sigma.obs"))
