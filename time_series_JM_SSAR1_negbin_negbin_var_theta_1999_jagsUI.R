...
jm <- jags(jags.data,
                   ...
                   model.file = 'models/model_SSAR1_negbin_negbin_var_theta.txt',
...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_JM_negbin_negbin_var_theta_1999_jagsUI.png',
         dpi = 600)

if (save.RData)
  saveRDS(results.JM_SSAR1_month_var_theta,
       file = paste0('RData/SSAR1_negbin_negbin_var_theta_JM_1999_jagsUI_', Sys.Date(), '.rds'))
