...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_SSAR1_month_Warmon_all_v2_jagsUI.png',
         dpi = 600)

if (save.RData)
  #save(results.Warmon_SSAR1_month_To2013,
  #     file = paste0('RData/SSAR1_month_W_all_', Sys.Date(), '.RData'))
  saveRDS(results.Warmon_SSAR1_month_all,
       file = paste0('RData/SSAR1_month_W_all_v2_jagsUI_', Sys.Date(), '.rds'))
