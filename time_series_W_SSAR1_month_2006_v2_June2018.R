...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_SSAR1_month_Warmon_2006_v2.png',
         dpi = 600)

if (save.RData)
  #save(results.Warmon_SSAR1_month_To2013,
  #     file = paste0('RData/SSAR1_month_W_all_', Sys.Date(), '.RData'))
  save(results.Warmon_SSAR1_month_2006,
       file = paste0('RData/SSAR1_month_W_2006_v2_', Sys.Date(), '.RData'))
