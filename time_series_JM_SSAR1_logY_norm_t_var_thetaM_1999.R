...
#load.module('dic')
jags.params <- c("theta.1", 'sigma.pro1', "simga.pro2", "sigma.obs",
...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_JM_logY_norm_t_varM_theta_1999.png',
         dpi = 600)

if (save.RData)
  saveRDS(results,
          file = paste0('RData/SSAR1_logY_norm_t_varM_theta_JM_1999_', Sys.Date(), '.rds'))
