...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_norm_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_norm_theta_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_norm_var_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_norm_var_theta_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_norm_varM_theta_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_norm_varM_thetaM_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_norm_var_thetaM_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_norm_thetaM_W_2006_2014_2018-10-17.rds")
...
Model 9 is similar to the first model but uses a different distribution for the state model; the observation is  modeled with t distribution. No seasonal change in variance or slope is considered. 
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_t_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_t_theta_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_t_var_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_t_var_theta_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_t_varM_theta_W_2006_2014_2018-10-18.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_t_varM_thetaM_W_2006_2014_2018-10-17.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_t_var_thetaM_W_2006_2014_2018-10-18.rds")
...
M <- readRDS("RData/jagsout_SSAR1_logY_norm_t_thetaM_W_2006_2014_2018-10-18.rds")
...
Estimated Pareto k statistics indicated that models 2, 8, 10, and 16 had acceptable predictive performance. We compared these models using using ELPD values.

```{r ModelComparison, include=TRUE}
M.compare <- compare(M2.loo.out, M8.loo.out, M10.loo.out, M16.loo.out)
print(M.compare)
```

Model 16, which contained month-specific slopes and one variance, turned out to be the best. M8 was a close second. The difference between them is the observation model, which is either t (M16) or normal (M8). 
