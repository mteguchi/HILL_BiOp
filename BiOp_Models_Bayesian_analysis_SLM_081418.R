...
model.loc <- "singleUQ_singletimeseries1.txt"   # paste("standard model files/singleUQ_singletimeseries1.txt",sep="")
...
# ***** 8/14/18: for n.samples <- 10000; mcmc.chains <- 2; mcmc.thin <- 50; mcmc.burn <- 1000
# JAGS output for model 'singleUQ_singletimeseries1.txt', generated by jagsUI.
# Estimates based on 2 chains of 550000 iterations,
# adaptation = 100 iterations (sufficient),
# burn-in = 50000 iterations and thin rate = 50,
# yielding 20000 total samples from the joint posterior.
# MCMC ran in parallel for 0.101 minutes at time 2018-08-14 15:24:06.
#
# mean     sd    2.5%     50%   97.5% overlap0     f  Rhat n.eff
# U          0.025  0.049  -0.075   0.027   0.117     TRUE 0.710 1.000 20000
# Q          0.052  0.024   0.019   0.048   0.110    FALSE 1.000 1.000 20000
# R          0.013  0.010   0.003   0.010   0.041    FALSE 1.000 1.000  6418
# X0         7.668  0.117   7.421   7.674   7.885    FALSE 1.000 1.000 20000
# X[1]       7.693  0.088   7.499   7.700   7.849    FALSE 1.000 1.000 20000
# X[2]       7.519  0.101   7.315   7.519   7.717    FALSE 1.000 1.000 20000
# X[3]       7.412  0.102   7.210   7.412   7.620    FALSE 1.000 1.000 20000
# X[4]       7.389  0.102   7.189   7.387   7.596    FALSE 1.000 1.000 20000
# X[5]       7.476  0.102   7.272   7.476   7.684    FALSE 1.000 1.000 20000
# X[6]       7.601  0.102   7.398   7.600   7.805    FALSE 1.000 1.000 20000
# X[7]       7.806  0.103   7.598   7.808   8.008    FALSE 1.000 1.000 20000
# X[8]       7.976  0.104   7.763   7.979   8.177    FALSE 1.000 1.001  2701
# X[9]       8.125  0.108   7.900   8.129   8.326    FALSE 1.000 1.000  9495
# X[10]      8.182  0.108   7.958   8.186   8.385    FALSE 1.000 1.000 14022
# X[11]      8.095  0.102   7.890   8.096   8.293    FALSE 1.000 1.000 20000
# X[12]      8.011  0.109   7.810   8.006   8.243    FALSE 1.000 1.000 20000
# X[13]      8.315  0.103   8.107   8.317   8.516    FALSE 1.000 1.000 20000
# X[14]      8.553  0.103   8.343   8.555   8.752    FALSE 1.000 1.000 20000
# X[15]      8.797  0.110   8.565   8.802   9.002    FALSE 1.000 1.000  3986
# X[16]      8.822  0.101   8.620   8.822   9.020    FALSE 1.000 1.000  6682
# X[17]      9.015  0.105   8.793   9.018   9.219    FALSE 1.000 1.000 11722
# X[18]      9.222  0.115   8.971   9.230   9.429    FALSE 1.000 1.000  5781
# X[19]      9.235  0.116   8.981   9.241   9.443    FALSE 1.000 1.000 20000
# X[20]      9.041  0.105   8.822   9.045   9.239    FALSE 1.000 1.000 20000
# X[21]      8.683  0.119   8.472   8.674   8.947    FALSE 1.000 1.000 20000
# X[22]      8.710  0.257   8.192   8.712   9.206    FALSE 1.000 1.000  7243
# deviance -40.537 14.379 -67.707 -40.892 -11.201    FALSE 0.997 1.000  5554
#
