...
jm <- jags(jags.data,
           ...
           model.file = 'models/model_SSAR1_logY_norm_t_var.txt',
...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_JM_logY_norm_t_var_1999.png',
         dpi = 600)

if (save.RData)
  saveRDS(results,
          file = paste0('RData/SSAR1_logY_norm_t_var_JM_1999_', Sys.Date(), '.rds'))
