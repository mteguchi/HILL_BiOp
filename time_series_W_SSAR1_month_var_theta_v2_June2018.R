...
jm <- jags.model(file = 'models/model_SSAR1_month_var_theta_Wermon_v2.txt',
                 data = bugs.data,
...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_SSAR1_month_var_theta_Warmon_all_v2.png',
         height = 6, width = 8, units = "in", dpi = 600)

if (save.RData)
  save(results.W_SSAR1_month_var_theta,
       file = paste0('RData/SSAR1_month_W_var_theta_all_v2_',
                     Sys.Date(), '.RData'))
