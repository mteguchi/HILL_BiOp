...
jm <- jags(jags.data,
           ...
           model.file = 'models/model_SSAR1_W_logY_norm_t_var.txt',
...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_W_logY_norm_t_var_2006.png',
         dpi = 600)

if (save.RData)
  saveRDS(results,
          file = paste0('RData/SSAR1_logY_norm_t_var_W_2006_', Sys.Date(), '.rds'))
