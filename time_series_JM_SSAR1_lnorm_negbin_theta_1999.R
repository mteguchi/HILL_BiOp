...
jm <- jags(jags.data,
                   ...
                   model.file = 'models/model_SSAR1_lnorm_negbin_theta.txt',
...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_JM_lnorm_negbin_theta_1999.png',
         dpi = 600)

if (save.RData)
  saveRDS(results,
       file = paste0('RData/SSAR1_lnorm_negbin_theta_JM_1999_', Sys.Date(), '.rds'))
