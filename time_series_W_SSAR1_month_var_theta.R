...
data.0 <- read.csv("data/NestCounts_Warmon_30May2018.csv")
...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_W_month_var_theta_To2013.png',
         height = 6, width = 8, units = "in", dpi = 600)

if (save.RData)
  save(results.W_SSAR1_month_var_theta,
       file = paste0('RData/SSAR1_month_W_var_theta_To2013_',
                     Sys.Date(), '.RData'))
