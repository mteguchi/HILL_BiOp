...
# v2 includes May as another "low" month
...
if (save.fig)
  ggsave(plot = p.1,
         filename = 'figures/predicted_counts_SSAR1_month_Warmon_all_v2.png',
         dpi = 600)
...
if (save.RData)
  ...
  save(results.Warmon_SSAR1_month_all,
       file = paste0('RData/SSAR1_month_W_all_v2_', Sys.Date(), '.RData'))
